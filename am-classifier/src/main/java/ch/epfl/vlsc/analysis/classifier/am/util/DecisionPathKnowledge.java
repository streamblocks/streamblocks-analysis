package ch.epfl.vlsc.analysis.classifier.am.util;
...
public class DecisionPathKnowledge {
    ...
    private final Exec destination;
    private ImmutableBitSet conditions;

    public DecisionPathKnowledge(Exec destination) {
        this(destination, ImmutableBitSet.empty(), ImmutableBitSet.empty());
    }

    private DecisionPathKnowledge(Exec destination, ImmutableBitSet trueConds, ImmutableBitSet falseConds) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(falseConds, other.falseConds);
    }
